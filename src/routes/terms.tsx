    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-4 md:px-8 py-16 md:py-24">
        ...
        <div className="mt-8 space-y-5 text-muted-foreground leading-relaxed">
          ...
          <p><span className="text-foreground font-medium">Refunds:</span> We offer a 30-day money-back guarantee as described on our pricing page. Contact coach@fortystronghealth.com to request a refund.</p>

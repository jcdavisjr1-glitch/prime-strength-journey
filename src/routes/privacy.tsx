    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-4 md:px-8 py-16 md:py-24">
        ...
        <div className="mt-8 space-y-5 text-muted-foreground leading-relaxed">
          ...
          <p><span className="text-foreground font-medium">Your choices:</span> You can access, update, or delete your account data by contacting coach@fortystronghealth.com. You can unsubscribe from marketing emails at any time.</p>
          ...
          <p><span className="text-foreground font-medium">Contact:</span> coach@fortystronghealth.com</p>
        </div>
      </div>
    </div>
  );
